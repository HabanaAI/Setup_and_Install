...
# Written by: Yaron Goldstein <ygoldstein@habana.ai>

: "${1?"Usage: $0 version revision mode [base,tensorflow,pytorch] os [ubuntu18.04,ubuntu20.04,amzn2]"}"
: "${2?"Usage: $0 version revision mode [base,tensorflow,pytorch] os [ubuntu18.04,ubuntu20.04,amzn2]"}"
: "${3?"Usage: $0 version revision mode [base,tensorflow,pytorch] os [ubuntu18.04,ubuntu20.04,amzn2]"}"
: "${4?"Usage: $0 version revision mode [base,tensorflow,pytorch] os [ubuntu18.04,ubuntu20.04,amzn2]"}"
